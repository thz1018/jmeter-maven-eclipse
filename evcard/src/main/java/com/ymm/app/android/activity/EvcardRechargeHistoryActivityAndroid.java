 ...
 * @author Cheney Wong
 */
public class EvcardRechargeHistoryActivityAndroid {
    private AndroidDriver<AndroidElement>androidDriver;
    private AndroidElement layout;
    private AndroidElement textView;

    public EvcardRechargeHistoryActivityAndroid(AndroidDriver androidDriver){
    ...
    public void clickInvoice(){
        GeneralAppOperation.appWait(1000);
        textView=androidDriver.findElement(By.id("com.baosight.carsharing:id/tv_make_invoce"));
        textView.click();
    }
}
